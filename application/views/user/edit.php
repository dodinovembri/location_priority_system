                            ...
                            <div class="example">
                                <form method="post" action="<?php echo base_url('user/update/'); echo $user->id; ?>" enctype="multipart/form-data">
                                    <div class="form-group form-material row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="name" value="<?php echo $user->name; ?>" placeholder="Masukkan Nama" autocomplete="off" required />
                                        </div>
                                    </div>
                                    <div class="form-group form-material row">
                                    ...
                                    <div class="form-group form-material row">
                                        ...
                                        <div class="col-md-9">
                                            <img src="<?php echo base_url('uploads/user/'); echo $user->gambar; ?>" width="50px" alt="">
